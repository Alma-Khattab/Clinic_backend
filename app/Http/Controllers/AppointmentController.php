...
class AppointmentController extends Controller
{
    ...
    public function book(StoreAppointmentRequest $request)
    {
        ...
        //  إشعار للمريض تم حجز موعدك بنجاح
    ...
    {
        $user = Auth::user();
        $appointment = Appointment::with('user', 'doctor.user')
            ->findOrFail($id);
    ...
    public function updateAppointment(Request $request, $id)
    {
        ...
        $appointment = Appointment::with('doctor.shift', 'doctor.user')
            ->findOrFail($id);
